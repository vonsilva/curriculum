...
questoes = [
    ...
    {
        'id': 2,
        'pergunta': 'Se um mes tem 30 dias e Gustavo ganha 2 reais por dia, quantos reais tera ao final do mes?',
...
def pegar_questao(q_id):
    for i in questoes:
        if i['id'] == q_id:
            return render_template('/questionario/questionario.html', nome=resultado[0]['usuario'] , id=i['id'], qt=i['pergunta']), 200
